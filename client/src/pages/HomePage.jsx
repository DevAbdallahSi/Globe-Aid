...
import travelImage from '../assets/images/image2.jpg'; // Ensure you have this image in your assets folder
...
const HomePage = () => {
    ...
    useEffect(() => {
        ...
        // Dynamically load the DataQueue voice widget script
    ...
    return (
        <div className="font-sans text-gray-800  min-h-screen overflow-x-hidden">
            {/* Navigation */}
                ...
                <section id="home" className="min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center justify-center text-center text-white relative overflow-hidden">
                    ...
                    <div className="w-full max-w-5xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
                        ...
                        <div className="w-full max-w-xl mx-auto">
                            ...
                            <dq-voice
                                agent-id="your-agent-id" // Replace with your actual agent ID
